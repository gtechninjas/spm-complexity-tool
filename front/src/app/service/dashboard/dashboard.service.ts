...
export class DashboardService {
  ...
  getOutputParam(fileLoc: FileLocation): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http.post(`${this.output_param_url}`, fileLoc).subscribe(
        async data => {
          return await resolve(data);
        },
        err => {
  ...
  getRecursion(fileLoc: FileLocation): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http.post(`${this.recursion_url}`, fileLoc).subscribe(
        async data => {
          return await resolve(data);
        },
        err => {
  ...
  getInheritance(fileLoc: FileLocation): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http.post(`${this.inheritance_url}`, fileLoc).subscribe(
        async data => {
          return await resolve(data);
        },
        err => {
  ...
  getControlStucture(fileLoc: FileLocation): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http.post(`${this.control_factor_url}`, fileLoc).subscribe(
        async data => {
          return await resolve(data);
        },
        err => {
  ...
  getNestingControlStucture(fileLoc: FileLocation): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http.post(`${this.nested_control_factor_url}`, fileLoc).subscribe(
        async data => {
          return await resolve(data);
        },
        err => {
  ...
  getSize(fileLoc: FileLocation): Promise<any> {
    return new Promise((resolve, reject) => {
      this.http.post(`${this.complexity_size_url}`, fileLoc).subscribe(
        async data => {
          return await resolve(data);
        },
        err => {
